...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Post Process IR"))
        self.selectFileBut.setText(_translate("MainWindow", "Select HDF5 File"))
        self.cmIronBut.setText(_translate("MainWindow", "Ironblack"))
        self.cmGrayBut.setText(_translate("MainWindow", "Grayscale"))
        self.cmRainBut.setText(_translate("MainWindow", "Rainbow"))
        self.playVidBut.setText(_translate("MainWindow", "Play Video"))
        self.pauseVidBut.setText(_translate("MainWindow", "Pause Video"))
        self.nextFrame.setText(_translate("MainWindow", "Next Frame"))
        self.prevFrame.setText(_translate("MainWindow", "Previous Frame"))
        self.label_10.setText(_translate("MainWindow", "Start Frame:"))
        self.label_11.setText(_translate("MainWindow", "Stop Frame:"))
        self.saveAsVideoSS.setText(_translate("MainWindow", "Save AVI Video from Start to Stop Frame"))
        self.tempScaleBut.setText(_translate("MainWindow", "Generate Figure with Temp Scale"))
        self.saveCvImageBut.setText(_translate("MainWindow", "Save PNG Image (Without Axes)"))
        self.makeTiffBut.setText(_translate("MainWindow", "Generate Tiff File (Full Duration)"))
        ...
        self.cursorTempLabel.setText(_translate("MainWindow", "Cursor Temp:"))
        self.maxTempLabel.setText(_translate("MainWindow", "Current Max Temp:"))
        self.maxTempLocLabel.setText(_translate("MainWindow", "Max Temp Loc:"))
        self.minTempLabel.setText(_translate("MainWindow", "Current Min Temp: "))
        self.minTempLocLabel.setText(_translate("MainWindow", "Min Temp Loc:"))
        self.currentFrameDisp.setText(_translate("MainWindow", "Current Frame:"))
        self.currentTimeLabel.setText(_translate("MainWindow", "Current Time:"))
        self.label.setText(_translate("MainWindow", "Command Log:"))
        self.label_14.setText(_translate("MainWindow", "File Selected: "))
        self.dispSelectedFile.setText(_translate("MainWindow", "Use Select File Button"))
        self.slStartF.setText(_translate("MainWindow", "Please Select File"))
        self.slMidF.setText(_translate("MainWindow", "Please Select File"))
        self.slEndF.setText(_translate("MainWindow", "Please Select File"))
        self.slStartT.setText(_translate("MainWindow", "Please Select File"))
        self.slMidT.setText(_translate("MainWindow", "Please Select File"))
        self.slEndT.setText(_translate("MainWindow", "Please Select File"))
